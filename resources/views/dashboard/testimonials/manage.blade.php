        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title">@lang('testimonials.sub_title')</h4>
                        </div>
                        <div class="col-md-4">
                            <div class="search-field d-none d-md-block">
                                <form class="align-items-center h-100" action="{{ route('testimonialSearch') }}" method="GET">
                    ...
                    @else
                        <table class="table table-striped text-center">
                            <thead class="blue-edit">
                                <tr>
                                    <th> @lang('testimonials.table_heading.0') </th>
                                    <th> @lang('testimonials.table_heading.1') </th>
                                    <th> @lang('testimonials.table_heading.2') </th>
                                    <th> @lang('testimonials.table_heading.3') </th>
                                    <th> @lang('testimonials.table_heading.4') </th>
                                    <th> @lang('testimonials.table_heading.5') </th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('testimonials.edit', ['testimonial' => $data->id]) }}"
                                                class="btn btn-inverse-warning btn-sm">
                                                <i class="mdi mdi-lead-pencil"></i>
                                            </a>
                                            <form class="del_form"
                                                action="{{ route('testimonials.destroy', ['testimonial' => $data->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
