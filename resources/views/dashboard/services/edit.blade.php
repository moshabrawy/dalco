                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="title_en">@lang('services.edit.input_labels.0')</label>
                                        <input required type="text" class="form-control" id="title_en" name="title_en"
                                            value="{{ $service->title_en }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="description_en">@lang('services.edit.input_labels.1')</label>
                                ...
                                <div class="col-md-6 arabic">
                                    <div class="form-group">
                                        <label for="title_ar">@lang('services.edit.input_labels.2')</label>
                                        <input required type="text" class="form-control" id="title_ar" name="title_ar"
                                            value="{{ $service->title_ar }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="description_ar">@lang('services.edit.input_labels.3')</label>
