        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title"> @lang('services.sub_title')</h4>
                        </div>
                        <div class="col-md-4">
                            <div class="search-field d-none d-md-block">
                                <form class="align-items-center h-100" action="{{ route('serviceSearch') }}" method="GET">
                    ...
                    @else
                        <table class="table table-striped text-center">
                            <thead class="blue-edit">
                                <tr>
                                    <th> @lang('services.table_heading.0') </th>
                                ...
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form class="del_form"
                                                action="{{ route('services.destroy', ['service' => $data->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
