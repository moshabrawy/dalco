                        ...
                        <form id="create" method="POST" action="{{ route('projects.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="type_en">@lang('projects.add.input_labels.1')</label>
                                    ...
                                    <div class="form-group">
                                        <label for="description_en">@lang('projects.add.input_labels.2')</label>
                                ...
                                <div class="col-md-6 arabic">
                                    <div class="form-group">
                                        <label for="title_ar">@lang('projects.add.input_labels.3')</label>
                                        <input required type="text" class="form-control" id="title_ar" name="title_ar">
                                    </div>
                                    <div class="form-group">
                                        <label for="project_image">@lang('projects.add.input_labels.4')</label>
                                        <input type="file" class="form-control" id="project_image" name="image" />
                                    </div>
                                    <div class="form-group">
                                        <label for="description_ar">@lang('projects.add.input_labels.5')</label>
