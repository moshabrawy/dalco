...
@section('content')
    <div class="page-header">
        <h3 class="page-title">
            ...
            @lang('projects.content_titles.0')
        </h3>
    </div>
    <div class="row">
        <!-- Table Content -->
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title">@lang('projects.sub_title')</h4>
                        </div>
                        <div class="col-md-4">
                    ...
                    @else
                        <table class="table table-striped text-center">
                            <thead class="blue-edit">
                                <tr>
                                    <th> @lang('projects.table_heading.0') </th>
                                    <th> @lang('projects.table_heading.1') </th>
                                    <th> @lang('projects.table_heading.2') </th>
                                    <th> @lang('projects.table_heading.3') </th>
                                    <th> @lang('projects.table_heading.4') </th>
                                    <th> @lang('projects.table_heading.5') </th>
                                </tr>
                            </thead>
                            <tbody>
