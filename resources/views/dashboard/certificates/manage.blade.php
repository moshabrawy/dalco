        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title">@lang('certificates.sub_title')</h4>
                        </div>
                        <div class="col-md-4">
                    ...
                    @else
                        <table class="table table-striped text-center">
                            <thead class="blue-edit">
                                <tr>
                                    <th> @lang('certificates.table_heading.0') </th>
                                    <th> @lang('certificates.table_heading.1') </th>
                                    <th> @lang('certificates.table_heading.2') </th>
                                    <th> @lang('certificates.table_heading.3') </th>
                                    <th> @lang('certificates.table_heading.4') </th>
                                    <th> @lang('certificates.table_heading.5') </th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('certificates.edit', ['certificate' => $data->id]) }}"
